...
def load_corpus(dataset_str):
    ...
    return:
        ...
        features, 矩阵，大小为(train_size+test_size)*word_embeddings_dim，矩阵allx和矩阵txy进行纵向拼接后的矩阵
...
def preprocess_features(features):
    ...
    return sparse_to_tuple(features) # 返回稀疏矩阵的三元组，row, col, data
